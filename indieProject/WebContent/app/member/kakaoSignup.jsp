...
<body class="is-preload">
	...
	<section id="main">
		<div class="container">
			...
			<!-- Content -->
			<form  name="signupForm"  action="${pageContext.request.contextPath}/member/KakaoJoinOkAction.me"  method="post">
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
	...
	<script src="${pageContext.request.contextPath}/assets/js/kakaoSignup.js"></script>
