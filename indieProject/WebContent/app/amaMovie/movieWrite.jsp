		...
		<div class="container">
			...
			<form name="movieWriteForm" method="post" action="${pageContext.request.contextPath}/amaMovie/MovieWriteOkAction.ama" enctype="multipart/form-data">
				<section id="step1">
					...
					<div id="posterHelp" style="display: none; resize: none;">첫번째로
				...
				<section id="step2" style="display: none;">
					<div class="row">
						...
						<div class="col-4 col-6-medium col-12-small" style="margin-right:auto;">
							<input type="text" name="amaTitleKor" id="amaTitleKor" value="" />
						</div>
					</div>
					<div class="row">
						<div class="col-custom col-2-medium col-12-small" style="margin-left: auto;">
						...
						<div class="col-4 col-6-medium col-12-small" style="margin-right:auto;">
							<input type="text" name="amaTitleEng" id="amaTitleEng" value="" />
						</div>
					</div>
<!-- 					<hr class="mobileHr" style="margin: 0.5em 0 0.5em 0;"> -->
					...
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="display: inherit; margin-right:auto;">
							<input type="text" name="amaMakeDate" id="datepicker" value="" readonly />
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="display: inherit; margin-right:auto;">
							<input type="text" name="amaMovieLength" id="amaMovieLength" value=""
					...
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="display: inherit; margin-right:auto;">
							<input type="text" name="amaDirector" id="amaDirector" value="" />
						</div>
					</div>
				...
				<section id="step3" style="display: none;">
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="margin-right: auto;">
							<textarea name="synopsis" id="synopsis" rows="3" cols="" style="resize: none;"></textarea>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="margin-right: auto;">
							<textarea name="theme" id="theme" rows="3" cols="" style="resize: none;"></textarea>
						</div>
					</div>
					...
					<div>
						<div class="row maker">
							...
							<div style="padding-bottom:0;" class="col-2 col-3-medium col-5-small duty">
								<input type="text" name="makerPosition" value="" />
							</div>
							<div style="padding-bottom:0;" class="col-2 col-3-medium col-5-small makerName">
								<input type="text" name="makerName" value="" />
							</div>
					...
					<div>
						<div class="row maker">
							...
							<div style="padding-bottom:0;" class="col-2 col-3-medium col-5-small cast">
								<input type="text" name="actorCast" value="" />
							</div>
	...
	<script
		src="${pageContext.request.contextPath}/assets/js/movieWrite.js"></script>
</body>
</html>