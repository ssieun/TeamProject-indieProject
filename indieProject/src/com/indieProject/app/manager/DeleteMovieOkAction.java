...
public class DeleteMovieOkAction implements Action{
	...
	public ActionForward execute(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		if(ma_dao.deleteMovie(amaNum)) {
			...
			if(ma_dao.setDeleteMovieYes(amaNum)) {
				System.out.println("삭제상태 업데이트 성공");
				...
				try {
					...
					//메일 제목
					msg.setSubject("[IndieProject] 영화삭제 안내메일");
					//메일 내용
					msg.setText("고객님의 영화 " + amaTitleKor + "이(가) 삭제처리 완료되었습니다.");
